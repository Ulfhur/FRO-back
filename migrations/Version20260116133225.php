 ...
 */
final class Version20260116133225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, note INT NOT NULL, content VARCHAR(255) NOT NULL, date_comment DATE NOT NULL, status VARCHAR(50) NOT NULL, article_id INT NOT NULL, INDEX IDX_9474526C7294869C (article_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(50) NOT NULL, mail VARCHAR(120) NOT NULL, password VARCHAR(50) NOT NULL, suspended TINYINT NOT NULL, change_password TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
